...
(() => {
  ...
  const textSureToCombineEquipped =
    parameters["textSureToCombineEquipped"] || "";
  ...
  const execCombine = (materialNum, candidateNum) => {
    ...
    const result = metaToItem(
      typeOfNum(candidateNum),
  ...
  Scene_ItemCombine.prototype.update = function () {
    ...
    this._navigationWindow.setPhase(
      this.phase,
  ...
  Scene_ItemCombine.prototype.createCandidateWindow = function () {
    ...
    this._candidateWindow.setHandler(
      "cancel",
  ...
  Window_Recipe.prototype.refresh = function () {
    ...
    if (this._itemNum && this._category) {
      ...
      const combineItem = metaToItem(
        typeOfNum(this._itemNum),
