...
(function () {
  ...
  const pReflectAnotherSide = toBoolean(
    parameters["ReflectAnotherSide"],
    false
  );
  ...
  const pToOriginalAnimation = toBoolean(
    parameters["ToOriginalAnimation"],
    false
  );
