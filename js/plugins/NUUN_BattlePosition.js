...
(() => {
  ...
  Game_Enemy.prototype.screenX = function () {
    return (
      (!$gameSystem.isSideView() && EnemyXPositionMode
        ? (Graphics.boxWidth - 808) / 2 + _Game_Enemy_screenX.call(this)
        : (Graphics.boxWidth / 808) * _Game_Enemy_screenX.call(this)) +
      enemyXPosition
    );
  };
  ...
  Game_Enemy.prototype.screenY = function () {
    return (
      (Graphics.boxHeight - 616) / 2 +
      enemyYPosition +
      _Game_Enemy_screenY.call(this)
    );
  };

  const _Sprite_Battleback_adjustPosition =
