...
(function () {
  ...
  Game_CharacterBase.prototype.setOffset2 = function (
    dx,
    dy,
    slx,
    sly,
  ...
  Sprite_Character.prototype.setFrame = function (sx, sy, pw, ph) {
    if (this._character._offsets2) {
      ...
      var sry = frameOffsets.y + frameOffsets.height;
      pw -= Math.min(
        Math.max(pw - srx, 0) + frameOffsets.x + Math.abs(offsets2.x),
        pw
      );
      ph -= Math.min(
        Math.max(ph - sry - Math.max(-offsets2.y, 0), 0) +
          frameOffsets.y +
          Math.abs(offsets2.y),
        ph
      );
  ...
  Game_CharacterBase.prototype.setImageGrid2 = function (
    name,
    index,
    dir,
    pattern,
  ...
  Game_CharacterBase.prototype.setImage2 = function (
    name,
    index,
    duration,
    needsWait
  ...
  Game_CharacterBase.prototype.setGrid2 = function (
    dir,
    pattern,
    duration,
    needsWait
  ...
  Game_CharacterBase.prototype.makeCrossFadeSpriteRequested = function () {
    return (
      this._IgDuration > 0 &&
      this._IgFrames === this._IgDuration &&
