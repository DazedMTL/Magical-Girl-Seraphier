...
(function () {
  ...
  Scene_Options.prototype.maxCommands = function () {
    return (
      _Scene_Options_maxCommands.apply(this, arguments) +
      param.NumberOptions.length +
      param.StringOptions.length +
      param.SwitchOptions.length +
      param.VolumeOptions.length
    );
  };
