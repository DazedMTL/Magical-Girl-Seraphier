...
(function () {
  ...
  function readParameter() {
    ...
    return {
      version: "1.2.0",
      baseAppearTime: pickIntegerValueFromParameter(
        parameter,
        "baseAppearTime",
        15
      ),
      baseViewTime: pickIntegerValueFromParameter(
        parameter,
        "baseViewTime",
        90
      ),
      baseFontSize: pickIntegerValueFromParameter(
        parameter,
        "baseFontSize",
        22
      ),
      basePadding: pickIntegerValueFromParameter(parameter, "basePadding", 4),
      baseItemPadding: pickIntegerValueFromParameter(
        parameter,
        "baseItemPadding",
        5
      ),
      ...
      advancedVisibleSwitch: pickIntegerValueFromParameter(
        parameter,
      ...
      advancedUiPaddingBottom: pickIntegerValueFromParameter(
        parameter,
        "advancedUiPaddingBottom",
        5
      ),
      advancedKeepMessage: pickBooleanValueFromParameter(
        parameter,
        "advancedKeepMessage",
        false
      ),
  ...
  function checkPluginVersion(version, requireVersion, errorMessage) {
    if (
      ...
      isGreaterThanOrEqualVersion(requireVersion, version)
    )
      return;
    alert(errorMessage);
    throw new Error(errorMessage);
  ...
  (() => {
    ...
    class Window_NotifyMessage extends Window_Base {
      ...
      refresh() {
        ...
        const { width: messageWidth, height: messageHeight } =
          this.textSizeEx(message);
    ...
    class NotifyManagerClass {
      ...
      update() {
        ...
        if (
          this._currentScene &&
          this._currentScene.torigoyaNotifyMessageContainer
        )
      ...
      startAppearAndExitAnimation(stack) {
        ...
        const animation = Torigoya.FrameTween.create(stack.notifyItem).group(
          this._group
        );
        ...
        animation.to(
          { openness: 255 },
          appearTime,
          Torigoya.FrameTween.Easing.easeInOutQuad
        );
    ...
    const upstream_Scene_Map_createWindowLayer =
      Scene_Map.prototype.createWindowLayer;
