...
(() => {
  ...
  const _Window_ItemCategory_onTouch = __base(
  ...
  const _Window_ItemList_isTouchedInsideFrame = __base(
  ...
  const _Scene_Item_createCategoryWindow =
  ...
  const _Scene_Item_activateItemWindow =
    Scene_Item.prototype.activateItemWindow;
  ...
  const _Scene_Shop_createCategoryWindow =
