...
(function () {
  ...
  Window_BattleLog.prototype.refresh = function () {
    ...
    if (pAutoWidth) {
      ...
      for (var line of this._lines) {
        ...
        var textPaddingWidth =
          textWidth + this.padding * 2 + this.textPadding() * 2;
    ...
    Window_BattleLog.prototype.drawTextEx = function (text, x, y) {
      if (text) {
        ...
        if (textWidth > textSpace) {
          this.contents.fontSize = Math.floor(
            (this.standardFontSize() * textSpace) / textWidth
          );
          textWidth = textSpace;
        }
  ...
  if (Utils.RPGMAKER_NAME == "MZ") {
     ...
     */
    var isSimpleMsgSideViewMZ = PluginManager._scripts.some(function (
      scriptName
    ) {
