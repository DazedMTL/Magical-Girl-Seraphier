...
(function () {
  ...
  Window_Fes.prototype.refresh = function () {
    ...
    if ($gameVariables.value(BBFAV) != 0) {
      ...
      this.drawText(
        $dataSystem.variables[$gameVariables.value(BBFAV)],
        0,
        0,
        width1
      );
      ...
      this.drawText(
        $gameVariables.value($gameVariables.value(BBFAV)),
        x,
        0,
        width2,
        "right"
    ...
    if ($gameVariables.value(BBFBV) != 0) {
      this.changeTextColor(this.textColor(BBFFC));
      this.drawText(
        $dataSystem.variables[$gameVariables.value(BBFBV)],
        0,
        BY,
        width1
      );
      ...
      this.drawText(
        $gameVariables.value($gameVariables.value(BBFBV)),
        x,
        BY,
        width2,
        "right"
    ...
    if ($gameVariables.value(BBFCV) != 0) {
      this.changeTextColor(this.textColor(BBFFC));
      this.drawText(
        $dataSystem.variables[$gameVariables.value(BBFCV)],
        0,
        CY,
        width1
      );
      ...
      this.drawText(
        $gameVariables.value($gameVariables.value(BBFCV)),
        x,
        CY,
        width2,
        "right"
    ...
    if ($gameVariables.value(BBFDV) != 0) {
      this.changeTextColor(this.textColor(BBFFC));
      this.drawText(
        $dataSystem.variables[$gameVariables.value(BBFDV)],
        0,
        DY,
        width1
      );
      ...
      this.drawText(
        $gameVariables.value($gameVariables.value(BBFDV)),
        x,
        DY,
        width2,
        "right"
