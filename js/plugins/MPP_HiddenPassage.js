...
(() => {
  ...
  const param_PassableRegionIds = convertToArray(
    parameters["Passable Region Ids"]
  );
  const param_ImpassableRegionIds = convertToArray(
    parameters["Impassable Region Ids"]
  );
  ...
  Tilemap.prototype._isHigherTile = function (tileId) {
    return this._forceHigher || _Tilemap__isHigherTile.apply(this, arguments);
  };
