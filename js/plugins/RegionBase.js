...
(() => {
   ...
   * Game_CharacterBase
   */
  const _Game_CharacterBase_isMapPassable =
  ...
  Game_Player.prototype.updateCurrentTerrainTags = function () {
    ...
    this.updateCurrentRegionAndTerrain(
      this._terrainTags,
      this._prevTerrainTags
    );
    this._prevTerrainTags = this._terrainTags;
  };

  Game_Player.prototype.updateCurrentRegionAndTerrain = function (
    current,
    prev
  ) {
  ...
  Game_Map.prototype.isCollidedByRegion = function (x, y, d) {
    ...
    return (
      collision.includes("collision_all") ||
  ...
  const _Game_Map_checkLayeredTilesFlags =
